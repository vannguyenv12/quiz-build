...
let ResultController = class ResultController {
    ...
    async create(createResultDto, currentUser) {
        const data = this.resultService.create(createResultDto, currentUser);
        return { message: 'Submit a quiz successfully', data };
    }
    findAll() {
...
ResultController = __decorate([
    (0, common_1.Controller)('api/v1/results'),
